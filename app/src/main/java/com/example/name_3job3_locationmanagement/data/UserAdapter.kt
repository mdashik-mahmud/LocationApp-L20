...
import com.example.name_3job3_locationmanagement.databinding.ItemUserBinding


class UserAdapter(private val onItemClick: (AppUsers) -> Unit) : ListAdapter<AppUsers, UserAdapter.UserViewHolder>(DIFF_CALLBACK) {
    companion object {
